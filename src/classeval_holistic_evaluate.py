"""
Evaluation script for the trained GRPO model on ClassEval holistic dataset.
"""
import argparse
import json
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate a trained GRPO model on ClassEval holistic dataset"
    )
    parser.add_argument(
        "--model_path",
        type=str,
    ...
    output_file = Path(args.output_dir) / f"{model_name}_evaluation.json"
