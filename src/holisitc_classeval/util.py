...
class InferenceUtil:
    ...
    def generate_prompt(instruction):
        return f"""Write the python code that appropriately completes the class and the methods, given the requirements. You should also include all import statement from the skeleton.\n{instruction}"""
